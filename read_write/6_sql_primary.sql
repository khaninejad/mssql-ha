...
'mssql-primary' WITH   
         ...
         PRIMARY_ROLE (ALLOW_CONNECTIONS = READ_WRITE,   
            READ_ONLY_ROUTING_LIST = ('mssql-sec1', 'mssql-sec2'),
            READ_WRITE_ROUTING_URL = 'TCP://mssql-primary:1433' )  
         ),   
      'mssql-sec1' WITH   
         (  
         ENDPOINT_URL = 'TCP://mssql-sec1:5022',  
         AVAILABILITY_MODE = SYNCHRONOUS_COMMIT,  
         FAILOVER_MODE = MANUAL, 
         SEEDING_MODE = AUTOMATIC,
         SECONDARY_ROLE (ALLOW_CONNECTIONS = ALL,   
            READ_ONLY_ROUTING_URL = 'TCP://mssql-sec1:1433' ),  
         PRIMARY_ROLE (ALLOW_CONNECTIONS = READ_WRITE,   
            READ_ONLY_ROUTING_LIST = ('mssql-primary', 'mssql-sec2'),  
            READ_WRITE_ROUTING_URL = 'TCP://mssql-sec1:1433' )
         ),   
      'mssql-sec2' WITH   
         (  
         ENDPOINT_URL = 'TCP://mssql-sec2:5022',  
         AVAILABILITY_MODE = ASYNCHRONOUS_COMMIT,  
         FAILOVER_MODE = MANUAL,  
         SEEDING_MODE = AUTOMATIC,
         SECONDARY_ROLE (ALLOW_CONNECTIONS = ALL,   
            READ_ONLY_ROUTING_URL = 'TCP://mssql-sec2:1433' ),  
         PRIMARY_ROLE (ALLOW_CONNECTIONS = READ_WRITE,   
            READ_ONLY_ROUTING_LIST = ('mssql-primary', 'mssql-sec1'),  
            READ_WRITE_ROUTING_URL = 'TCP://mssql-sec2:1433' )
         );
